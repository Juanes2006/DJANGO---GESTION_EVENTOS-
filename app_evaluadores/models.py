...
class Criterio(models.Model):
    ...
    cri_evento_fk = models.ForeignKey(Evento,null=True, on_delete=models.CASCADE)  # ← CORRECTO
...
class Calificacion(models.Model):
    ...
    cal_evaluador_fk = models.ForeignKey(Evaluador,null=True, on_delete=models.CASCADE)
    cal_criterio_fk = models.ForeignKey(Criterio,null=True, on_delete=models.CASCADE)
    cal_participante_fk = models.ForeignKey(Participantes,null=True, on_delete=models.CASCADE)
...
class Instrumento(models.Model):
    ...
    inst_evento_fk = models.ForeignKey(Evento,null=True, on_delete=models.CASCADE)
    def __str__(self):
...
class InformacionTecnica(models.Model):
    ...
    inf_evento_fk = models.ForeignKey(Evento,null=True, on_delete=models.CASCADE)
    def __str__(self):
