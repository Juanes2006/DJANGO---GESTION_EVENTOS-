...
class PlantillaCertificado(models.Model):
    ...
    titulo = models.CharField(max_length=255, default="CERTIFICADO DE PARTICIPACIÓN", blank=True)
    subtitulo = models.CharField(max_length=255, default="Se otorga el presente certificado a", blank=True)
    texto_firma = models.CharField(max_length=255, default="Coordinador del Evento", blank=True)
    ...
    fuente_titulo = models.CharField(max_length=50, choices=FUENTES, default="Helvetica-Bold", blank=True)
    tamano_titulo = models.IntegerField(default=28, blank=True)
    fuente_nombre = models.CharField(max_length=50, choices=FUENTES, default="Helvetica-Bold", blank=True)
    ...
    # Imágenes
    logo = models.ImageField(upload_to="certificados/logos/", blank=True, null=True)
    sello = models.ImageField(upload_to="certificados/sellos/", blank=True, null=True)
    firma = models.ImageField(upload_to="certificados/firmas/", blank=True, null=True)
