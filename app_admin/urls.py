...
urlpatterns = [
    ...
    # Actualización de estado (participantes o asistentes)
    path('actualizar_estado/', views.actualizar_estado, name='actualizar_estado'),
    
    path('evento/<int:eva_id>/editar/', views.editar_evaluador, name='editar_evaluador'),
    path('evento/<int:eva_id>/eliminar/', views.eliminar_evaluador, name='eliminar_evaluador'),
    
    path('agregar_evaluador/', views.agregar_evaluador, name='agregar_evaluador'),
